...
\begin{figure}[h]
    ...
    \includegraphics[width=0.7\textwidth]{tfp_decomposition.png}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.9\textwidth]{tfp_contribution_total.png}
    \label{fig:tfp_contribution_total}
\end{figure}

\begin{figure}[h]
    \centering
    \caption{Industrial Contributions to TFP Growth (Productivity)}
    \includegraphics[width=0.9\textwidth]{tfp_contribution_productivity.png}
    \label{fig:tfp_contribution_productivity}
\end{figure}

\begin{figure}[h]
    \centering
    \caption{Industrial Contributions to TFP Growth (Baumol)}
    \includegraphics[width=0.9\textwidth]{tfp_contribution_baumol.png}
    \label{fig:tfp_contribution_baumol}
\end{figure}

\begin{figure}[h]
    \centering
    \caption{Industrial Contributions to TFP Growth (Capital)}
    \includegraphics[width=0.9\textwidth]{tfp_contribution_capital.png}
    \label{fig:tfp_contribution_capital}
\end{figure}

\begin{figure}[h]
    \centering
    \caption{Industrial Contributions to TFP Growth (Labor)}
    \includegraphics[width=0.9\textwidth]{tfp_contribution_labor.png}
    \label{fig:tfp_contribution_labor}
\end{figure}
...
\includetables{tfp_growth_no_oge}

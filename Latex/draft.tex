...
Canada’s productivity performance has weakened substantially over the past several decades, with the slowdown becoming especially pronounced after 2000. While Canada experienced robust gains in total-factor productivity (TFP) during the postwar period, recent years have seen persistently low—at times even negative—TFP growth, contributing to slower real wage growth and diminishing improvements in living standards. Despite the centrality of productivity to long-run economic performance, the sources of Canada’s stagnation remain debated. Explanations range from declining dynamism and innovation to adverse sectoral shifts, resource-sector volatility, and structural barriers to investment. Yet relatively little work has quantified the relative importance of these channels using a consistent, long-run, industry-level framework.

This paper provides a simple and transparent accounting of Canada’s aggregate TFP growth from 1961 to 2019 using a decomposition grounded entirely in observable data. Following a standard industry-level growth-accounting approach, I separate aggregate TFP growth into three components: (i) within-industry productivity improvements, (ii) structural change captured through Baumol effects, and (iii) reallocation of capital and labor across industries. This decomposition allows us to measure how much of Canada’s productivity performance reflects technological and efficiency gains inside industries, how much stems from changes in the economy’s sectoral composition, and how much is due to shifts in factor inputs across sectors.

The results show that Canada’s post-2000 productivity stagnation is driven overwhelmingly by a sharp decline in within-industry TFP growth. Although Baumol effects become increasingly negative over time—as output and employment shift toward slower-growing service industries—their overall magnitude remains modest relative to the collapse in within-industry productivity. Factor reallocation contributes little throughout the sample, suggesting that changes in the distribution of capital and labor across sectors do not play a central role in Canada’s long-run productivity dynamics.

By documenting these patterns over nearly six decades of Canadian economic history, the paper offers a coherent empirical foundation for understanding the country’s productivity challenges. The findings point toward explanations rooted primarily in declining technological progress and efficiency improvements within industries, with mild but growing compositional drags. These results help clarify which mechanisms should— and should not—be at the center of policy discussions aimed at improving Canada’s productivity performance.
...
\end{alignat}
In this equation, term \eqref{eq:productivity_1} weighs industry-level TFP growth by each industry's initial share of value-added. That is, if we freeze each industry's share of nominal value-added, we capture the contribution of within-industry productivity improvements alone--how much aggregate TFP has grown purely because each industry became more productive over time.

Term \eqref{eq:baumol_1} instead weighs industry-level TFP growth by the change in each industry's share of value-added between dates $t_0$ and $t_1$. Therefore, it measures how the changing industrial composition of the economy contributes to aggregate TFP growth. This term is negative when industries with low productivity growth become more important in the economy, or vice-versa.
